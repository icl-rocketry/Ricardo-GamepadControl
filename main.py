...
if __name__ == "__main__":
    ...
    ap.add_argument("--no-socketio", required=False, help="disable socketio",action = 'store_true')
    ...
    gc = GamepadControl(args['config'],args['joy_n'],args['host'],args['port'],args['no_socketio'],args['fps'],args['delta'],args['verbose'],args['debug']) 
